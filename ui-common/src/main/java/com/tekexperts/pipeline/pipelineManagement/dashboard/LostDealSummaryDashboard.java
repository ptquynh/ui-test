...
public class LostDealSummaryDashboard extends PipelineBase{
	...
	//Sales Rep dropdown
	public By ELEMENT_DASHBOARD_LOSTDEALSUMMARY_SALESREP_DROPDOWN=By.xpath(".//*[@id='right-side']//div[7]/div/button[contains(@class,'dropdown')]");
	public String ELEMENT_DASHBOARD_LOSTDEALSUMMARY_SALEREP_ITEM=".//*[@id='right-side']//div[7]/div/ul//*[contains(text(),'$fullName')]";
	...
	public void goToSaleRepList(){
		...
		click(ELEMENT_DASHBOARD_LOSTDEALSUMMARY_SALESREP_DROPDOWN);
		Utils.pause(3000);
	}
	/**
	...
	public void verifySaleRepInList(String fullName){
		...
		waitForAndGetElement(ELEMENT_DASHBOARD_LOSTDEALSUMMARY_SALEREP_ITEM.replace("$fullName",fullName),2000,1);
