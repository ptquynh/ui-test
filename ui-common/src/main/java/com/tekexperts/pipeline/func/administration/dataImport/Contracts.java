...
public class Contracts extends PipelineBase{
	...
	//Choose file filed
	public By ELEMENT_DATAIMPORT_ATR_CHOOSEFILE_FIELD=By.xpath("");
	//Import button
	public By ELEMENT_DATAIMPORT_ATR_IMPORT_BTN=By.xpath("");
	//View data filter
	public By ELEMENT_DATAIMPORT_ATR_VIEWDATA_FILTER=By.xpath("");
	//File name filter
	public By ELEMENT_DATAIMPORT_ATR_FILENAME_FILTER=By.xpath("");
	//File sixe filter
	public By ELEMENT_DATAIMPORT_ATR_FILESIZE_FILTER=By.xpath("");
	//Upload data filter
	public By ELEMENT_DATAIMPORT_ATR_UPLOADDATA_FILTER=By.xpath("");
	//Upload by filter
	public By ELEMENT_DATAIMPORT_ATR_UPLOADBY_FILTER=By.xpath("");
	//View link
	public String ELEMENT_DATAIMPORT_ATR_VIEW_LINK="";
	//File name link
	public String ELEMENT_DATAIMPORT_ATR_FILENAME_LINK="";
