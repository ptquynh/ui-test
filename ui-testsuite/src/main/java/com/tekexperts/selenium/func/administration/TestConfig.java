...
import com.tekexperts.pipeline.pipelineManagement.operation.FalloutMultiCloseDate;
import com.tekexperts.pipeline.pipelineManagement.operation.FalloutNegativeOrders;
import com.tekexperts.pipeline.pipelineManagement.operation.FalloutNoPreviousDoc;
import com.tekexperts.pipeline.pipelineManagement.operation.FalloutNotReconciled;
...
public class TestConfig extends PipelineBase {
	...
	FalloutUnassignedOrders falloutUnassignedOrders;
	FalloutDuplicatePreviousDoc falloutDupPrevDoc;
	FalloutMultiCloseDate fallMultiCloseDate;
	FalloutNegativeOrders fallNegaOrders;
	FalloutNoPreviousDoc fallNoPrevDoc;
	FalloutNotReconciled fallNoReconciled;
	FalloutHome falloutHomepage;
	...
	public void setUpBeforeMethod() throws Exception{
		...
		dataImportHome = new DataImportHome(driver);
		contract = new Contracts(driver);
		falloutUnassignedOrders = new FalloutUnassignedOrders(driver);
		falloutHomepage = new FalloutHome(driver);
		falloutDupPrevDoc=new FalloutDuplicatePreviousDoc(driver);
		fallMultiCloseDate=new FalloutMultiCloseDate(driver);
		fallNegaOrders=new FalloutNegativeOrders(driver);
		fallNoPrevDoc=new FalloutNoPreviousDoc(driver);
		fallNoReconciled= new FalloutNotReconciled(driver);
